...

{
	...
	case 6: case 9: 	/* deciduous forest, tropic evergreen */
		/*  calculating aboveground biomass based on LAI  J. Liu 2002 */
		...
		coef_leaf_respir=0.015/RTIMES;  /*  leaf resp co.  kg C-1 d-1 kg-1    */
        	coef_stem_respir=0.0035/RTIMES*0.65;  /*  stem resp co.   kg C-1 d-1 kg-1      */
        	coef_root_respir=0.0025/RTIMES*0.85;  /*  root resp co.   kg C-1 d-1 kg-1   */
		coef_fineroot_respir=0.003/RTIMES;    /*  fine root resp co.   kg C-1 d-1 kg-1	*/
	...
	case 10: /* mix forest */
		...
		biomass_leaf_o=0.045*biomass;	/* leaf C of overstory */
		biomass_stem_o=0.95*biomass;	/* stem C of overstory */
		biomass_root_o=(0.454*biomass+1.432*pow(biomass,0.639))/2.0;
		/*biomass_root_o=0.232*biomass; // root C of overstoryKurz 1996 */
		biomass_leaf_u=0.3*biomass_leaf_o;	/* leaf C of understory */
		biomass_stem_u=0.015*biomass_stem_o;  	/* stem C of understory */
		biomass_root_u=0.03*biomass_root_o;	/* root C of understory */

		coef_leaf_respir=0.008/RTIMES;  /*  leaf resp co.  kg C-1 d-1 kg-1    */
        	coef_stem_respir=0.0028/RTIMES;  /*  stem resp co.   kg C-1 d-1 kg-1      */
        	coef_root_respir=0.0023/RTIMES;  /*  root resp co.   kg C-1 d-1 kg-1   */
		coef_fineroot_respir=0.003/RTIMES;    /*  fine root resp co.   kg C-1 d-1 kg-1	*/
	...
	case 25: case 40: case 14: case 15:
